...
const SubmissionsPanel: FC<Props> = (props) => {
  ...
  const [objectiveSubmissionMap, setObjectiveSubmissionMap] =
    useState<Map<number, Submission[]>>(null);
            ...
            return (
              ...
              >
                <Typography variant="h4">
                  <b>
                    {objectiveSubmissionMap.get(objectiveId)[0].objectiveTitle}
                  </b>{" "}
                  feladat beadásai
                </Typography>
                  ...
                  return (
                    <>
                      <SubmissionDisplayContainer
                        ...
                        displayExtraProps={{
                          showObjectiveTitle: !isValidNumber(
                            props.filteredObjectiveId
                          ),
