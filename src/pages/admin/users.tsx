        ...
        <>
            ...
            <AdminNavBar/>
                ...
                <EditAuthoritiesDialog
                    onClose={() => setEditAuthoritiesDialogOpen(false)}
                                ...
                                {usedEndpoint.data.map((userInfo: UserInfo) => {
                                    return (
                                        <tr key={userInfo.userId} style={{textAlign: 'center'}}>
                                            ...
                                            <td>
                                                <b>{userInfo.enabled ? 'Y' : 'N'}</b>
                                            </td>
                                            <td>{userInfo.registered}</td>
                                            <td>
                                                <b>{userInfo.isAcceptedByEmail ? 'Y' : 'N'}</b>
                                            </td>
                                            ...
                                            <td>
                                                <button onClick={() => editAuthorities(userInfo.userId)}>Edit authorities</button>
                                            </td>
                                            <td>
